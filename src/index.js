  ...
  <div className="main">
    ...
    <Router>
      <div>
        <ul className="list">
          <li>
            <Link to="/WithDefaultProps">WithDefaultProps</Link>
          </li>
          <li>
            <Link to="/LoadingSpinnerExample">LoadingSpinnerExample</Link>
          </li>
          <li>
            <Link to="/ResponsiveExample">ResponsiveExample</Link>
          </li>
          <li>
            <Link to="/SmoothScrollExample">SmoothScrollExample</Link>
          </li>
          <li>
            <Link to="/ResponsiveSmoothScrollExample">
              ResonsiveSmoothScrollExample
            </Link>
          </li>
        </ul>
        ...
        <Route
          path="/ResponsiveSmoothScrollExample"
          component={ResponsiveSmoothScrollExample}
        />
      </div>
    </Router>
  </div>
